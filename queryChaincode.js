...
function queryChaincode() {
    return __awaiter(this, void 0, void 0, function () {
        var config, client, channel, tlsSuite, tlsSuitePath, storePath, store, signedCretPEMPath, keyName, privateKeyPEMPath, peer;
        return __generator(this, function (_a) {
            switch (_a.label) {
                ...
                case 1:
                    ...
                    client.setTlsClientCertAndKey(fs.readFileSync(path.join(__dirname, config.org2.user.admin.tls_cacerts), { encoding: "utf8" }), fs.readFileSync(path.join(__dirname, config.org2.user.admin.tls_key), { encoding: "utf8" }));
                ...
                case 2:
                    _a.sent();
                    peer = client.newPeer(config.org2.peer1.requests, {
                    ...
                    return [4 /*yield*/, channel.queryByChaincode({
                            chaincodeId: "mycc",
                            fcn: "query",
                            args: ["a"]
                        })];
...
queryChaincode().then(function (payloads) {
